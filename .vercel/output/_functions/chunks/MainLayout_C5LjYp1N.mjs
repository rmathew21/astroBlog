import { c as createComponent, m as maybeRenderHead, d as renderComponent, r as renderTemplate, b as addAttribute, a as createAstro, k as renderSlot, l as renderHead } from './astro/server_yIbkrCIN.mjs';
import 'kleur/colors';
import { $ as $$Image } from './_astro_assets_CJyki7vT.mjs';
import 'clsx';
import { g as getCollection } from './_astro_content_DyyibTSY.mjs';
/* empty css                         */
...
const logo = new Proxy({"src":"/_astro/logo.Bp-tjQcT.png","width":200,"height":200,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/robinmathew/Desktop/code2/astroBlog/src/images/logo.png";
							}
...
}, "/Users/robinmathew/Desktop/code2/astroBlog/src/components/Navbar.astro", void 0);
...
}, "/Users/robinmathew/Desktop/code2/astroBlog/src/components/Footer.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="description"', `><link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.15/dist/tailwind.min.css" rel="stylesheet"><script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.0/flowbite.js" integrity="sha512-BJ/5sR2hFxQTKin/55JQCcMTObShDBAmVjL/3NR/MVcrhyOazJjAgvROem03+HYyGw16SVdSfoWCFGr9syxAKA==" crossorigin="anonymous" referrerpolicy="no-referrer"> console.log('MainLayout is rendering..');
  
  <\/script><title>`, " - ", "</title>", '</head> <body class=""> ', ' <section class="container mx-auto max-w-screen-xl mt-10 px-8"> ', " </section> ", " <!--</div>  end of section --> </body></html><!-- <style>\n	html,\n	body {\n		margin: 0;\n		width: 100%;\n		height: 100%;\n	}\n</style> -->"])), addAttribute(SITE_DESCRIPTION, "content"), SITE_TITLE, Title, renderHead(), renderComponent($$result, "Navbar", $$Navbar, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}));
}, "/Users/robinmathew/Desktop/code2/astroBlog/src/layouts/MainLayout.astro", void 0);
