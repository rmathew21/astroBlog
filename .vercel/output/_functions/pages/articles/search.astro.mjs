...
const $$Search = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "Title": "Search Results" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<a href="/articles" class="inline-block bg-gray-100 p-2 mb-5 hover:bg-indigo-500 
...
}, "/Users/robinmathew/Desktop/code2/astroBlog/src/pages/articles/search.astro", void 0);

const $$file = "/Users/robinmathew/Desktop/code2/astroBlog/src/pages/articles/search.astro";
